...
export default function Plans() {
  ...
  const fetchData = async () => {
    try {
      ...
      setPlanes(jsonResponse.list || []); // guardar lista de planes
    } catch (err: any) {
  ...
  return (
    <div className="container py-5">
      <ul className="nav nav-tab justify-content-center align-items-center gap-4 py-3 mb-4">
        <li className="nav-item d-flex align-items-center gap-2">
          <span className={`step-circle ${activeStep === 1 ? "active" : ""}`}>
            1
          </span>
          <span
        ...
        <li className="nav-item d-flex align-items-center gap-2">
          <span className={`step-circle ${activeStep === 2 ? "active" : ""}`}>
            2
          </span>
          <span
        ...
        {activeStep === 1 && (
          <div className="tab-pane active text-center">
            ...
            <div className="row row-cols-1 row-cols-md-2 mb-3 mt-4">
              <div className="col">
                <div
                  className={`card h-100 rounded-3 shadow-sm option-card ${
            ...
            {selectedOption && (
              <div className="row row-cols-1 row-cols-md-3 mb-3 mt-4">
                {planes.map((plan:any) => 
